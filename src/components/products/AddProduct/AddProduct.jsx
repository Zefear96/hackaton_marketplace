...
const AddProduct = () => {
  ...
  return 
    ...
    <div>
      ...
      <input type="text" placeholder="volume" name="volume" onChange={handleInp}/>
      <input type="text" placeholder="alcohol percentage" name="alcohol_percentage" onChange={handleInp}/>
      <input type="text" placeholder="image" name="image" onChange={handleInp}/>
      <button onClick={() => {
        addProduct(product)
        navigate('/products')
      }}>Add Product</button>
