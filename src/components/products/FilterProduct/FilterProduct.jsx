  ...
  return <div>
    <FormControl>
      ...
      >
        ...
        <FormControlLabel value="Red Wine" control={<Radio />} label="Red Wine" />
        <FormControlLabel value="White Wine" control={<Radio />} label="White Wine" />
        <FormControlLabel value="Champagne" control={<Radio />} label="Champagne" />
        <FormControlLabel value="Absinthe" control={<Radio />} label="Absinthe" />
        <FormControlLabel value="Cognac" control={<Radio />} label="Cognac" />
      </RadioGroup>
    </FormControl>
    </div>;
};
